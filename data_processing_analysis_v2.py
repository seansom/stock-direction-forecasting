...
def train_test_split(data, time_steps):
    ...
    data_len = len(data)  
    #data = data.iloc[:-time_steps]
    
    target_indices = list(range(time_steps, data_len, time_steps))
...
def main():
    ...
    batch_dataset, col_names, grnd_truth = get_dataset(stock_ticker, analysis_range=('2022-02-13', '2022-02-15'))
