...
def experiment(stock_ticker, time_steps, drop_col=None, test_on_val=False):
...
def feature_selection(stock_ticker, timesteps):
    ...
    for _ in range(repeats):
        curr_model_perf, _, _ = experiment(stock_ticker, timesteps, drop_col=dropped_features, test_on_val=True)
...
def main():
    ...
    # dropped features
    dropped_features = ['cmf', 'atr', 'cci', 'adx', 'slope', 'k_values', 'd_values', 'macd', 'signal', 'divergence', 'gdp', 'real_interest_rate', 'roe', 'eps', 'p/e', 'psei_returns', 'sentiment']
    ...
    for i in range(repeats):
        ...
        perf, _, _ = experiment(stock_ticker, time_steps, drop_col=dropped_features)
...
if __name__ == '__main__':
    ...
    # pruned_features = feature_selection('ALI', 1)
    # print(f"Dropped Features: {pruned_features}")


    ['cmf', 'atr', 'adx', 'signal', 'divergence', 'gdp', 'real_interest_rate', 'roe', 'p/e', 'psei_returns', 'sentiment']