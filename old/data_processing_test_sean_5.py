...
def train_test_split(data, time_steps, train_size, test_size):
    ...
    for i in range(train_test_sets_num):
        ...
        curr_train = data[i * test_size : i * test_size + train_size + time_steps]
        curr_test = data[i * test_size + train_size : (i + 1) * test_size + train_size + time_steps]
...
def main():
    stock_ticker = 'AP'
    windowed_train_test_sets = get_dataset(stock_ticker, date_range=None, time_steps=5, train_size=95, test_size=5, drop_col=None)
