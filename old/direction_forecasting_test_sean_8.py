...
def experiment(data):
    ...
    for index in range(data_len):
        ...
        lstm_model.fit(shuffled_train_x, shuffled_train_y, epochs=epochs, validation_split=0.1052, verbose=0, callbacks=[early_stopping_callback, print_train_progress_callback])
        ...
        print(f"Batch DA: {curr_directional_accuracy}")
...
def main():
    ...
    # dropped features
    dropped_features =  None #['gdp', 'inflation', 'real_interest_rate', 'roe', 'eps']
