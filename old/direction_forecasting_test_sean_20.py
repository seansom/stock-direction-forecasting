# no random splitting with shuffling, walk forward validation with SHITTON of indicators, CNN-lSTM implementation
...
def make_lstm_model(input_shape):
    ...
    lstm_model = keras.models.Sequential([
        ...
        keras.layers.LSTM(units=64, return_sequences=True, recurrent_dropout=0.2),
        keras.layers.LSTM(units=64, return_sequences=True, recurrent_dropout=0.2),
        keras.layers.LSTM(units=64, return_sequences=True, recurrent_dropout=0.2),
