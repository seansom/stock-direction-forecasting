# This version of the direction forecasting mode recreates the model from the preliminary work done

# Model Type: LSTM
# Inputs: ['stock_return' (log format), 'volume']
# Outputs: stock_return
# Loss: RMSE/MSE
# Optimizer: Adam
# Epochs: 100 (with early stopping mechanism)
# Timesteps: 1
...
from data_processing_Prelim_Work import get_dataset, inverse_transform_data
...
def main():
    ...
    for i in range(repeats):
        ...
        perf, _, _, _, _ = experiment(stock_ticker, time_steps=time_steps, date_range=None, drop_col=None)
