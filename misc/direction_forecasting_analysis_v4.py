...
from data_processing_analysis_v4 import get_dataset, inverse_transform_data
...
def analysis_FS_HPS(analysis_type):
    ...
    for ticker in stock_ticker_list:
        ...
        units.append(hps['units'])
        layers.append(hps['layers'])
        dropout.append(hps['dropout'])
