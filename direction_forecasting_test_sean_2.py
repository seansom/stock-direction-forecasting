...
def feature_selection(stock_ticker, time_steps):
...
def main():
    ...
    # dropped features
    dropped_features = ['wr', 'cmf', 'atr', 'adx', 'slope', 'k_values', 'd_values', 'macd', 'signal', 'divergence', 'gdp', 'inflation', 'real_interest_rate', 'roe', 'eps', 'p/e', 'psei_returns']
