...
def preprocess_data(stock_ticker):
    ...
    #('2016-11-16', '2022-12-16')
    processed_data = get_technical_data(stock_ticker, get_dates_five_years(testing=True))
...
def invert_scaled_data(data, scaler, col_names, feature="log_return"):
...
def experiment(stock_ticker, time_steps, epochs):
    ...
    data = preprocess_data(stock_ticker)
    ...
    test_y = invert_scaled_data(test_y, scaler, col_names, feature="log_return")
    predictions = invert_scaled_data(predictions, scaler, col_names, feature="log_return")
