...
import datetime, requests, json, math, random, shelve, sys, os
...
def data_processing(technical_data, fundamental_data, time_steps, drop_col=None):
    """Splits a dataset into training and testing samples.
    The train and test data are split with a ratio of 8:2.
...
def get_dataset(stock_ticker, date_range=None, time_steps=1, drop_col=None):
    ...
    scaler, train, test, col_names, train_targets, test_targets, train_indices, test_indices = data_processing(technical_data, fundamental_data, time_steps, drop_col)
